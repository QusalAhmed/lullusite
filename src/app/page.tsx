...
// Assumption: public site base URL is https://lullusite.com — change metadataBase if your production domain differs
export const metadata: Metadata = {
    title: { default: 'Lullu Site — Website Builder & Business Automation', template: '%s | Lullu Site' },
    ...
    metadataBase: new URL('https://lullusite.com'),
    keywords: [
        'website builder',
        'business automation',
        'ecommerce',
    ...
    authors: [{ name: 'Lullu Site', url: 'https://lullusite.com' }],
    ...
    openGraph: {
        title: 'Lullu Site — Website Builder & Business Automation',
        description: 'Build fast, beautiful websites and automate workflows — all in one platform. Launch sites, manage products, payments and marketing with Lullu.',
        url: new URL('/', 'https://lullusite.com'),
        siteName: 'Lullu Site',
        images: [
            { url: new URL('/home/undraw-heatmap-uyye.png', 'https://lullusite.com'), alt: 'Lullu Site product screenshot' },
            { url: new URL('/home/logo.png', 'https://lullusite.com'), alt: 'Lullu Site logo' }
        ],
        locale: 'en_US',
        type: 'website',
    },
    twitter: {
        ...
        title: 'Lullu Site — Website Builder & Business Automation',
        description: 'Build fast, beautiful websites and automate workflows — all in one platform.',
        images: ['https://lullusite.com/home/undraw-heatmap-uyye.png'],
        creator: '@Qusal'
    },
    alternates: {
        canonical: 'https://lullusite.com/',
        languages: {
            'en-US': 'https://lullusite.com/'
        }
    }
};
    ...
    return (
        <div className="bg-gray-900 text-gray-100 min-h-screen">
                ...
                <nav className="items-center pt-5 px-4 mx-auto max-w-screen-xl sm:px-8 sm:flex sm:space-x-6">
                    <div className="flex items-center justify-between w-full">
                        <Link href="/" className="flex items-center">
                            <Image src='/home/logo.png' width={140} height={50} alt="Lullu Site logo" />
                        </Link>
            ...
            <Script id="schema-org" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
                {
                    ...
                    "@type": "Organization",
                    "name": "Lullu Site",
                    "url": "https://lullusite.com",
                    "logo": "https://lullusite.com/home/logo.png",
                    "sameAs": [
                        "https://twitter.com/lullusite",
                        "https://www.linkedin.com/company/lullusite",
                        "https://github.com/lullusite"
                    ]
                },
                {
                    "@context": "https://schema.org",
                    ...
                    "publisher": {
                        ...
                        "logo": {
                            "@type": "ImageObject",
                            "url": "https://lullusite.com/home/logo.png"
                        }
                    },
                    "potentialAction": {
                        "@type": "SearchAction",
                        "target": "https://lullusite.com/search?q={search_term_string}",
            ...
            <section className="mt-10 mx-auto max-w-screen-xl pb-12 px-4 lg:flex md:px-8 items-center">
                <div className="space-y-6 flex-1 sm:text-center lg:text-left">
                    ...
                    <p className="text-gray-300 max-w-2xl leading-relaxed">
                        Lullu Site is a website builder and business automation platform for agencies and creators. Launch fast, accept
            ...
            <section id="performance" className="py-16 bg-gray-800">
                <div className="max-w-screen-xl mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold text-white">Speed & Performance</h2>
                    <p className="text-gray-300 mt-3 max-w-2xl mx-auto">Optimized for fast load times and snappy interactions — better SEO and conversions.</p>

                    <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <Reveal className="bg-gray-900 p-6 rounded-lg" hover>
                            <div className="text-white font-semibold text-xl">Lighthouse</div>
                            <div className="mt-3 text-3xl font-bold text-indigo-400">99</div>
                            <div className="text-sm text-gray-400 mt-1">Performance score</div>
                        </Reveal>

                        <Reveal className="bg-gray-900 p-6 rounded-lg" hover delay={0.04}>
                            <div className="text-white font-semibold text-xl">TTFB</div>
                            <div className="mt-3 text-3xl font-bold text-indigo-400">120ms</div>
                            <div className="text-sm text-gray-400 mt-1">Server response time</div>
                        </Reveal>

                        <Reveal className="bg-gray-900 p-6 rounded-lg" hover delay={0.08}>
                            <div className="text-white font-semibold text-xl">LCP</div>
                            <div className="mt-3 text-3xl font-bold text-indigo-400">1.1s</div>
                            <div className="text-sm text-gray-400 mt-1">Largest Contentful Paint</div>
                        </Reveal>

                        <Reveal className="bg-gray-900 p-6 rounded-lg" hover delay={0.12}>
                            <div className="text-white font-semibold text-xl">Page Size</div>
                            <div className="mt-3 text-3xl font-bold text-indigo-400">120kb</div>
                            <div className="text-sm text-gray-400 mt-1">Compressed transfer size</div>
                        </Reveal>
                    </div>

                    <div className="mt-8 max-w-2xl mx-auto text-left text-gray-300">
                        <ul className="space-y-2 text-sm">
                            <li>Edge-first deployment with Vercel for global CDN and low latency.</li>
                            <li>Automatic image optimization with Next.js Image and responsive sizes.</li>
                            <li>Cache-first strategies, SSR/ISR and incremental builds where appropriate.</li>
                            <li>Measured with Lighthouse and Real User Monitoring (RUM) for continuous improvement.</li>
                        </ul>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-screen-xl mx-auto px-4 text-center">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-gray-900 p-6 rounded-lg">
                            <p className="text-gray-300">&#34;Lullu Site cut our launch time in half. The automations and built-in payments saved us weeks of engineering work.&#34;</p>
            ...
            <footer className="bg-gray-900 text-gray-300">
                <div className="max-w-screen-xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <div className="flex items-center">
                            <Image src="/home/logo.png" alt="Lullu Site" width={140} height={50} />
                        </div>
                ...
                <div className="border-t border-gray-800">
                    <div className="max-w-screen-xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between text-sm text-gray-500">
                        <div>© {new Date().getFullYear()} Lullu Site — All rights reserved.</div>
